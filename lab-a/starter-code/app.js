...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  const totalSum = sum(firstSum[0], c);
  const totalProduct = multiply(firstProduct[0], c);

  const sumMessage = `${a} and ${b} and ${c} sum to ${totalSum[0]}.`;
  const productMessage = `The product of ${a} and ${b} and ${c} is ${totalProduct[0]}.`;

  output.push(totalSum[0], totalProduct[0], sumMessage, productMessage);
